<template>
  ...
  >
    ...
    <!-- Carte principale -->
    <div class="relative bg-[#0297B8] text-white w-96 rounded-3xl shadow-lg overflow-hidden pt-4 pb-6">
    ...
    <div class="flex justify-center gap-4 mt-4 mb-8">
      <button
        class="bg-[#0297B8] text-white px-6 py-3 rounded-lg flex items-center gap-2 shadow  transition-colors"
      >
