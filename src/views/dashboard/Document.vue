  ...
  <div class="min-h-screen bg-gray-100 p-6">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="flex flex-col md:flex-row items-center justify-between mb-6 gap-4">
        ...
        <button
          @click="showAdd = true"
          class="bg-[#0297B8] text-white px-5 py-2 rounded-lg shadow hover:bg-[#0280a5] transition flex items-center gap-2"
        >
      ...
      <div class="mb-4">
        <input
          ...
          class="w-full md:w-1/2 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0297B8] outline-none"
        />
      </div>
      ...
      <div class="bg-white shadow-md rounded-lg overflow-x-auto">
        <table class="w-full border-collapse text-sm">
          <thead class="bg-[#0297B8] text-white uppercase">
            <tr>
            ...
            >
              ...
              <td class="p-3 text-center">
                <button
                  ...
                  class="text-gray-500 hover:text-[#0297B8] text-lg transition"
                >
                  📎
                </button>
              </td>
    ...
    >
      <div class="bg-white rounded-2xl w-full max-w-4xl shadow-2xl relative overflow-hidden border border-gray-100 max-h-[90vh] overflow-y-auto">
        ...
        <div class="bg-[#0297B8] p-6 text-white sticky top-0 z-10">
        ...
        <div class="p-8">
          ...
          <div class="text-center mb-8">
            <div class="flex justify-center mb-4">
              <div class="bg-[#0297B8] p-3 rounded-lg">
                <img
            ...
            <div class="w-20 h-1 bg-[#0297B8] mx-auto"></div>
          </div>
          ...
          <div class="mb-8">
            ...
            <div class="bg-gray-50 rounded-lg p-4">
              <div class="flex justify-between items-center mb-2">
                ...
                <span class="text-[#0297B8] font-semibold">1 sur 12</span>
              </div>
          ...
          <div class="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-[#0297B8]/10 rounded-xl p-4 border border-[#0297B8]/20">
              <h3 class="font-semibold text-[#0297B8] mb-2">OMCUT technique</h3>
              <p class="text-[#0297B8]">SPECIFICATIONS API</p>
            </div>
          </div>
          ...
          <div class="bg-[#0297B8]/10 rounded-xl p-4 border border-[#0297B8]/20 mb-8">
            <h3 class="font-semibold text-[#0297B8] mb-3">Éditeur</h3>
            <div class="flex gap-3">
              <button class="bg-[#0297B8] text-white px-4 py-2 rounded-lg hover:bg-[#0280a5] transition-colors text-sm font-medium">
                Approuver
              </button>
          ...
          <div class="bg-[#0297B8]/10 rounded-xl p-4 border border-[#0297B8]/20">
            <h3 class="font-semibold text-[#0297B8] mb-3">SPECIFICATIONS API</h3>
            <div class="text-[#0297B8]">
        ...
        <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 sticky bottom-0">
          <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div class="flex gap-3">
              ...
              <button
                @click="showPreview = false"
                class="bg-gradient-to-r from-[#0297B8] to-[#0280a5] text-white px-8 py-3 rounded-xl hover:from-[#0280a5] hover:to-[#026c8c] transition-all duration-300 shadow-lg hover:shadow-xl font-semibold flex items-center gap-2"
              >
                <span>✓</span>
        ...
        <!-- Effet de brillance -->
        <div class="absolute top-0 left-0 w-full h-1 bg-[#0297B8]"></div>
      </div>
    </div>
    ...
    >
      <div class="bg-white rounded-xl w-[90%] md:w-[60%] p-8 shadow-lg relative">
        <h3 class="text-2xl font-bold mb-6 text-center text-[#0297B8]">✏️ Éditer un document</h3>
        <form class="space-y-6">
          <div class="grid md:grid-cols-2 gap-4">
            <div>
              <label class="font-semibold text-[#0297B8]">Entreprise destinataire :</label>
              <input type="text" placeholder="Ex: SCB" class="w-full border rounded-lg px-3 py-2 mt-1 outline-none focus:ring-2 focus:ring-[#0297B8]" />
            </div>
            <div>
              <label class="font-semibold text-[#0297B8]">Titre :</label>
              <input type="text" placeholder="Permission RE" class="w-full border rounded-lg px-3 py-2 mt-1 outline-none focus:ring-2 focus:ring-[#0297B8]" />
            </div>
          </div>
          <div>
            <label class="font-semibold text-[#0297B8]">Document :</label>
            <input type="file" class="w-full border rounded-lg px-3 py-2 mt-1" />
          </div>
          <div>
            <label class="font-semibold text-[#0297B8]">Description :</label>
            <textarea rows="3" placeholder="Permission" class="w-full border rounded-lg px-3 py-2 mt-1 outline-none focus:ring-2 focus:ring-[#0297B8]"></textarea>
          </div>
          <div class="flex justify-between gap-4">
            ...
            <div class="flex gap-2">
              ...
              <button type="submit" class="bg-[#0297B8] text-white px-6 py-2 rounded-lg hover:bg-[#0280a5] transition">Soumettre</button>
            </div>
          </div>
        </form>
      </div>
    ...
    >
      <div class="bg-white rounded-xl w-[90%] md:w-[60%] p-8 shadow-lg relative">
        <h3 class="text-2xl font-bold mb-6 text-center text-[#0297B8]">📝 Soumettre un document</h3>
        <form class="space-y-6" @submit.prevent="addDocument">
          <div class="grid md:grid-cols-2 gap-4">
            <div>
              <label class="font-semibold text-[#0297B8]">Entreprise destinataire :</label>
              <input v-model="newDoc.compagnie" type="text" placeholder="Ex: SCB" class="w-full border rounded-lg px-3 py-2 mt-1 outline-none focus:ring-2 focus:ring-[#0297B8]" />
            </div>
            <div>
              <label class="font-semibold text-[#0297B8]">Titre :</label>
              <input v-model="newDoc.titre" type="text" placeholder="Permission RE" class="w-full border rounded-lg px-3 py-2 mt-1 outline-none focus:ring-2 focus:ring-[#0297B8]" />
            </div>
          </div>
          <div>
            <label class="font-semibold text-[#0297B8]">Document :</label>
          ...
          <div>
            <label class="font-semibold text-[#0297B8]">Description :</label>
            <textarea v-model="newDoc.description" rows="3" placeholder="Permission" class="w-full border rounded-lg px-3 py-2 mt-1 outline-none focus:ring-2 focus:ring-[#0297B8]"></textarea>
          </div>
          <div class="flex justify-between gap-4">
