    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="mb-8">
        <div class="flex justify-between items-center mb-4">
          ...
          <button
            @click="addComment"
            class="px-6 py-2 bg-[#02739A] text-white rounded-lg hover:bg-[#02739A] transition-colors flex items-center gap-2"
          >
        ...
        <div class="flex gap-4 mb-6">
          <input
            ...
            class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#02739A] focus:border-transparent"
            v-model="searchQuery"
          >
          <button class="px-6 py-2 bg-[#02739A] text-white rounded-lg hover:bg-[#02739A] transition-colors">
            Filtrer
          </button>
        </div>
      </div>
          ...
          <div v-for="comment in filteredComments" :key="comment.id" class="mb-6 last:mb-0">
            <div class="flex gap-4">
              ...
              <div class="flex-shrink-0">
                <div class="w-10 h-10 bg-[#02739A] rounded-full flex items-center justify-center text-white font-semibold">
              ...
              <div class="flex-1">
                <div class="flex items-center justify-between mb-2">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="text-[#02739A] hover:text-[#02739A] p-1 rounded transition-colors"
                      title="Modifier"
                    >
                ...
                <div class="flex items-center gap-4 text-sm text-gray-500">
                  <button
                    ...
                    class="flex items-center gap-1 hover:text-[#02739A] transition-colors"
                    :class="{ 'text-[#02739A]': comment.isLiked }"
                  >
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div v-if="comment.showReply" class="mt-4 pl-4 border-l-2 border-gray-200">
                  <textarea
                    ...
                    rows="2"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#02739A] focus:border-transparent mb-2"
                  ...
                  <div class="flex justify-end gap-2">
                    ...
                    <button
                      ...
                      class="px-3 py-1 text-sm bg-[#02739A] text-white rounded hover:bg-blue-400 transition-colors"
                    >
                      Répondre
                    </button>
                  </div>
                ...
                <div v-if="comment.replies && comment.replies.length > 0" class="mt-4 space-y-3">
                  ...
                  >
                    <div class="flex gap-3">
                      <div class="flex-shrink-0">
                        <div class="w-8 h-8 bg-[#02739A] rounded-full flex items-center justify-center text-white text-xs font-semibold">
