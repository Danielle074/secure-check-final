    ...
    <div class="flex items-center gap-3 mb-4">
      <div class="relative flex-1">
        <input
          ...
          type="text"
          placeholder="Search"
          class="border border-gray-300 rounded-lg px-10 py-2 w-1/2 focus:outline-none focus:ring-2 focus:ring-[#02739A]"
        />
    ...
    <div class="flex items-center justify-between px-4 py-3 bg-white border-t mt-4">
      ...
      <div class="flex items-center gap-1">
        ...
        <button
          ...
          :key="page"
          @click="goToPage(page)"
          :class="['px-3 py-1 rounded-md border border-gray-300 hover:bg-gray-50', currentPage === page ? 'bg-[#02739A] text-white border-[#02739A]' : '']"
        >
          {{ page }}
        </button>
