        ...
        <div class="space-y-6">
          ...
          <div class="flex items-center gap-2">
            <input
              ...
              id="notify"
              v-model="notifyUsers"
              class="rounded border-gray-300 text-[#02739A] focus:ring-[#02739A]"
            >
          ...
          <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
            ...
            <button
              ...
              class="px-6 py-2 bg-[#02739A] text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
