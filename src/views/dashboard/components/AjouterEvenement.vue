<template>
  ...
  <div class="bg-white p-6 rounded-lg shadow-md relative">
    ...
    <form @submit.prevent="ajouterEvenement" class="grid grid-cols-2 gap-4">
      ...
      <div>
        ...
        <input v-model="newEvent.entreprise" type="text" required
               class="w-full border rounded-lg p-2 bg-gray-100 focus:ring-2 focus:ring-[#0297B8]" />
      </div>
      ...
      <div>
        ...
        <select v-model="newEvent.ville" class="w-full border rounded-lg p-2 bg-gray-100 focus:ring-2 focus:ring-[#0297B8]">
      ...
      <div>
        ...
        <select v-model="newEvent.pays" class="w-full border rounded-lg p-2 bg-gray-100 focus:ring-2 focus:ring-[#0297B8]">
      ...
      <div class="col-span-2 flex justify-center mt-6">
        <button type="submit"
                class="bg-[#0297B8] text-white px-8 py-2 rounded-lg font-semibold hover:bg-[#02739A] transition">
          Soumettre
        </button>
      </div>
    </form>
    ...
    <div v-if="showQrCard"
      ...
      <div class="relative bg-[#0297B8] text-white w-full max-w-sm rounded-3xl shadow-lg overflow-hidden p-6">
        <div class="flex justify-center -mt-14 mb-4">
          <div class="w-28 h-28 bg-white rounded-full flex items-center justify-center shadow-md border-4 border-[#0297B8]">
        ...
        <div class="flex justify-center gap-4 mt-6">
          <button class="bg-[#0297B8] text-black px-6 py-3 rounded-lg flex items-center gap-2 shadow hover:bg-white transition-colors">
