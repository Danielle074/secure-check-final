      ...
      <div class="mb-8">
        ...
        <div class="flex gap-4 mb-6">
          <input
            ...
            class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0297B8] focus:border-transparent"
            v-model="searchQuery"
          />
          <button
            class="px-6 py-2 bg-[#0297B8] text-white rounded-lg hover:bg-[#0297B8] transition-colors"
          >
            Filtrer
          </button>
        </div>
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="project in filteredProjects" :key="project.id" class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-[#0297B8]">
                  {{ project.title }}
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                  {{ project.startDate }}
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                  ...
                  <button
                    ...
                    class="text-[#0297B8] hover:text-blue-800"
                  >
