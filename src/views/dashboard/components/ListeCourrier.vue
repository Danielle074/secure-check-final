    ...
    <div v-if="!courrierSelectionne" class="flex justify-between items-center mb-6">
      ...
      <div class="w-full max-w-md">
        <input
          ...
          class="w-full p-3 rounded-lg border border-gray-300 focus:border-[#02739A] focus:ring-2 focus:ring-[#02739A] focus:outline-none transition-all duration-200"
        />
      </div>
    </div>
    ...
    >
      ...
      <div class="overflow-auto flex-1">
        <table class="min-w-full text-left table-auto">
          <thead class="bg-[#02739A] text-white sticky top-0">
            <tr>
            ...
            >
              ...
              <td class="px-4 py-3">
                <button
                  ...
                  class="text-sm font-medium text-[#02739A] hover:text-[#015d7a] hover:underline transition-colors duration-200"
                >
                  🧷
                </button>
              </td>
              ...
              <td class="px-4 py-3 relative">
                ...
                >
                  <div class="py-1">
                    ...
                    <button
                      @click="ajouter()"
                      class="flex items-center w-full px-4 py-2 text-sm text-[#02739A] hover:bg-blue-50 transition-colors duration-150"
                    >
                      <i class="bx bx-plus-circle mr-2 text-[#02739A]"></i>
                      Ajouter
                    </button>
        ...
        <div class="flex items-center gap-1">
          ...
          <button
            ...
            :class="[
              ...
              currentPage === page
                ? 'bg-[#02739A] text-white border-[#02739A] hover:bg-[#015d7a]'
...
<div v-else class="bg-white rounded-lg shadow-lg p-8 flex-1 relative max-w-4xl mx-auto">
  ...
  <div class="mb-4">
    <button
      @click="retourListe"
      class="flex items-center gap-2 text-[#02739A] hover:text-[#015d7a] text-lg font-semibold transition-colors duration-200"
    >
  ...
  <div class="flex justify-between mb-6">
    <!-- Destinateur -->
    <div class="space-y-1">
      <p class="text-xl font-bold text-[#02739A]">{{ courrierSelectionne.destinateur }}</p>
  ...
  <!-- Objet -->
  <h3 class="text-xl font-bold mb-6 text-[#02739A] border-b-2 border-[#02739A] pb-2">
  ...
  <!-- Signature -->
  <div class="mb-12">
    <p class="font-bold text-lg text-[#02739A]">Cordialement,</p>
  ...
  <div class="flex justify-center gap-3">
    <button
      ...
      class="px-4 py-2 bg-[#02739A] text-white rounded-lg hover:bg-[#025c7a] transition"
    >
      Télécharger
    </button>
    <button
