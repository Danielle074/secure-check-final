    ...
    <div class="max-w-5xl mx-auto overflow-hidden">
      ...
      <div class="mb-8">
        <div class="flex justify-between items-center mb-4">
          ...
          <button
            @click="addTask"
            class="px-6 py-2 bg-[#02739A] text-white rounded-lg hover:bg-blue-400 transition-colors flex items-center gap-2"
          >
        ...
        <div class="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <input
            type="date"
            class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#02739A] focus:border-transparent"
            v-model="dateFilter"
          >
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="task in filteredTasks" :key="task.id" class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-[#02739A]">{{ task.title }}</td>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                  <div class="flex items-center gap-2">
                    ...
                    <button
                      ...
                      class="text-[#02739A] hover:text-blue-400"
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                  <div class="flex items-center gap-2">
                    ...
                    <button
                      ...
                      class="text-[#02739A] hover:text-blue-400 p-1 rounded"
                      title="Éditer"
                    >
