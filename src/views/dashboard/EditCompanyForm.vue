<template>
  ...
  >
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
      <!-- En-tête du modal -->
      <div class="bg-gradient-to-r from-[#02739A] to-[#0297B8] p-4">
      ...
      <div class="overflow-y-auto max-h-[calc(90vh-80px)]">
        <form @submit.prevent="submitForm" class="p-6 space-y-6">
            ...
            <div class="flex items-center gap-4">
              ...
              <div class="flex-1">
                ...
                <input
                  type="file"
                  @change="onFileChange"
                  class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#0297B8] file:text-white hover:file:bg-[#02739A]"
                  accept="image/*"
                />
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  type="text"
                  class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#0297B8] focus:border-transparent"
          ...
          <div class="flex justify-end gap-3 pt-4">
            ...
            <button
              type="submit"
              class="px-6 py-2.5 bg-[#02739A] text-white rounded-lg text-sm font-medium hover:bg-[#025d7a] transition-colors flex items-center gap-2"
            >
